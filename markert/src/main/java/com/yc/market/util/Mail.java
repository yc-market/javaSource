...
public class Mail {
    ...
    private  String myEmailAccount = "xzq953761972@163.com";
    private  String myEmailPassword = "123456789-";
    ...
    public  MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        message.setFrom(new InternetAddress(sendMail, "尤洪商城", "UTF-8"));
    ...
    public Mail(String receiveMailAccount, String message) {
		super();
		this.receiveMailAccount = receiveMailAccount;
		Message += message;
	}
