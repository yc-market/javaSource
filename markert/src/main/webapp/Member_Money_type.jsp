...
<div class="i_bg bg_color">
	...
	<div class="m_content">
		...
		<div class="m_right">
            <p></p>			
            <div class="mem_tit">
            	<span class="fr" style="font-size:12px; color:#55555; font-family:'宋体'; margin-top:5px;"></span>帐户绑定设置
            </div>
			...
			<table border="0" class="ma_tab" style="width:930px; margin-bottom:30px;" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td colspan="2"><input type="text" class="add_ipt" name="accname" style="width:190px;" /></td>
              </tr>
              <tr>                                                                                                                                                    
